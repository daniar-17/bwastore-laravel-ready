            ...
            <div class="card-body">
              <div class="row">
                <div class="col-12 col-md-4">
                  <img
                    src="{{ url($transaction->product->galleries->first()->photos ?? '') }}"
                    class="w-100 mb-3"
              ...
              <form action="{{ route('dashboard-transactions-update', $transaction->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mt-4">
                  <div class="col-12 text-right mt-4">
                    <a href="{{ route('dashboard-transactions') }}" class="btn btn-secondary mr-2">
                        Cancel
                    </a>
                    <button
                      type="submit"
...
@push('addon-script')
  <script script src="/vendor/vue/vue.js"></script>
    <script>
